...
Brave Core is a set of changes, APIs, and scripts used for customising Chromium to make the Brave browser.  Also, please visit https://github.com/brave/brave-browser
